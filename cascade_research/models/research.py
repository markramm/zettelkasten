...
class ResearchEntry(Entry):
    ...
    entry_subtype: str = (
        "actor"  # actor, organization, theme, mechanism, scene, victim, statistic, document, event
    )
    ...
    def create_actor(cls, name: str, **kwargs) -> "ResearchEntry":
        ...
        return cls(id=entry_id, title=name, entry_subtype="actor", **kwargs)
    ...
    def create_organization(cls, name: str, **kwargs) -> "ResearchEntry":
        ...
        return cls(id=entry_id, title=name, entry_subtype="organization", **kwargs)
