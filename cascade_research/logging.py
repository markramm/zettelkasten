"""
Structured Logging for cascade-research
...
# Module logger names
LOGGER_NAMES = {
    "root": "cascade_research",
    "storage": "cascade_research.storage",
    "index": "cascade_research.storage.index",
    "database": "cascade_research.storage.database",
    "migrations": "cascade_research.storage.migrations",
    "repository": "cascade_research.storage.repository",
    "services": "cascade_research.services",
    "api": "cascade_research.server.api",
    "cli": "cascade_research.cli",
    "mcp": "cascade_research.mcp",
}
...
def configure_logging(
    ...
    """
    root_logger = logging.getLogger("cascade_research")
