...
class OAuthCallbackHandler(BaseHTTPRequestHandler):
    ...
    def do_GET(self) -> None:
        ...
        self.wfile.write(b"""
            ...
            <p>You can close this window and return to cascade-research.</p>
...
def start_oauth_flow(
    ...
    if not client_id or not client_secret:
        return False, (
            ...
            "Set CASCADE_GITHUB_CLIENT_ID and CASCADE_GITHUB_CLIENT_SECRET environment variables, "
            "or use 'cascade-research auth github-setup' to configure."
        )
