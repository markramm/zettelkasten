...
class FullAccessCLI:
    ...
    def cmd_create(self, args) -> int:
        ...
        from .models import EventEntry, GenericEntry, OrganizationEntry, PersonEntry
        ...
        try:
            if args.type == "event":
                ...
                entry = OrganizationEntry.create(name=args.title, importance=args.importance or 5)
                entry.body = args.body or ""
                if args.tags:
                    entry.tags = args.tags.split(",")
